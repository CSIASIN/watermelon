...
if (!function_exists('wm_breadcrumb')) :
  function wm_breadcrumb() {
    ...
    if (!is_home()) {
      ...
      echo '<li class="breadcrumb-item"><a href="' . HOMEURL . '">' . '' . apply_filters('bootscore/icon/home', '<i class="fa-solid fa-house"></i>') . '<span class="visually-hidden">' . __('Home', 'bootscore') . '</span>' . '</a></li>';
